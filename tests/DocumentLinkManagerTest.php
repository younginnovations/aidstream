...
//        $this->documentLinkRepository->shouldReceive('update')->once()->with([], ['document_link' => 'documentLink'])->andReturn(true);
////        $this->logger->shouldReceive('info')->once()->with("Document Link Updated", array('for' => 'documentLink'));
...
//    {
//        $this->documentLinkRepository->shouldReceive('update')->once()->with([], ['document_link' => 'documentLink'])->andReturn(false);
//        $this->logger->shouldReceive('error')->once()->with('Document Link could not be updated due to', ['OrganizationDocumentLink' => []]);
//        $this->assertFalse($this->docLinkManager->update([],['document_link' => 'documentLink']));
//    }
//
