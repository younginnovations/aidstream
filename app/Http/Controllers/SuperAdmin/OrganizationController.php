    ...
    public function oldListOrganizations(Request $request)
    {
        if (isTzSubDomain()) {
            ...
            if ($request->has('organization')) {
                ...
                $organizations = (session('role_id') == 3 || session('role_id') == 9) ? $this->adminManager->getOrganizations( null, $selectedVersion, $selectedSysVersion) : $this->groupManager->getGroupsByUserId(Auth::user()->id);
            }
        }
