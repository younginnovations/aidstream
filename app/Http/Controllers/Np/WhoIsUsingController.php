...
class WhoIsUsingController extends Controller
{
    ...
    public function showActivity($orgId, $activityId)
    {
        ...
        return view('np.perfectViewer.activity-viewer', compact('organization', 'activity', 'user', 'recipientCountries', 'activityPublishedStatus', 'defaultFieldValues', 'transactions'));
    }
    ...
    public function showOrganization($organizationId, Request $request)
    {
        ...
        return view('np.perfectViewer.organization-viewer', compact('activities', 'organizations', 'user', 'recipientCountries'));
    }
