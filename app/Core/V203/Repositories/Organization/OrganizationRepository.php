<?php namespace App\Core\V203\Repositories\Organization;

use App\Core\V203\Repositories\Organization\OrganizationRepository as V201;
...
//                    $package = $settings['registry_info'][0]['publisher_id'] . '-org';
    ...
    public function saveOrganizationInformation($organizationInfo, $organization)
    {
        ...
        $organization->secondary_reporter = $organizationInfo['secondary_reporter'];
