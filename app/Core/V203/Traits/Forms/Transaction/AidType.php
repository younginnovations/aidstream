<?php namespace App\Core\V203\Traits\Forms\Transaction;
...
trait AidType
{
    ...
    {
        return $this->addCollection('aid_type', 'Activity\Transactions\DefaultAidType', '', [], trans('elementForm.aid_type'));
    }
