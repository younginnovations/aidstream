...
class ParticipatingOrganization extends BaseForm
{
    ...
    {
        $this->addSelect('organization_role', $this->getCodeList('OrganisationRole', 'Activity'), 'Organisation Role', $this->addHelpText('Activity_ParticipatingOrg-role'), null, true)
             ...
             ->addNarrative('narrative', 'Organisation Name')
