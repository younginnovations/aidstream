...
class ParticipatingOrganization extends BaseForm
{
    ...
    {
        $this->addSelect('organization_role', $this->getCodeList('OrganisationRole', 'Activity'), 'Organization Role', $this->addHelpText('Activity_ParticipatingOrg-role'), null, true)
