...
class OrganizationGroup extends Request
{
    ...
    public function rules()
    {
        ...
        $rules[sprintf('%s.password_confirmation', $adminGroup)] = 'required';
        if ($this->method() === 'PUT') {
    ...
    public function messages()
    {
        ...
        $messages[sprintf(' % s . password_confirmation . required', $adminGroup)] = 'Password confirmation is required';
