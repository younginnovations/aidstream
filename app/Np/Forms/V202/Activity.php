...
class Activity extends NpBaseForm
{
    ...
    public function buildForm()
    {
        ...
        $locationFormPath                  = $this->getFormPath('Location');
        ...
        $this->addText('activity_identifier', trans('lite/elementForm.activity_identifier'))
             ...
             ->addText('activity_title_in_np', trans('Activity Name in Nepali'))
             ->addSelect(
                 'activity_status',
            ...
            //  ->addButton('add_more_location', 'Add another Municipality', 'location', 'add_more')
