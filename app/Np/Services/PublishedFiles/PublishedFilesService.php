<?php namespace App\Np\Services\PublishedFiles;
 ...
 * @package App\Np\Services\PublishedFiles
 */
class PublishedFilesService
{
     ...
     * @param NpPublishedFilesRepositoryInterface $publishedFilesRepository
     * @param Publisher                         $publisher
     * @param LoggerInterface                   $logger
     */
    public function __construct(NpPublishedFilesRepositoryInterface $publishedFilesRepository, Publisher $publisher, LoggerInterface $logger)
    {
