@if(!emptyOrHasEmptyTemplate($org_name))
    <div class="activity-element-wrapper">
        ...
        <a href="{{ url('/organization/' . $orgId . '/name') }}" class="edit-element">@lang('global.edit')</a>
        <a href="{{ route('organization.delete-element', [$orgId, 'name']) }}" class="delete pull-right">@lang('global.delete')</a>
    </div>
@endif
