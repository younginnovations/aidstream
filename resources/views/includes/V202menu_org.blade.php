        ...
        <div class="panel-body">
            <ul class="nav">
                <li>
                    ...
                    <a href="{{ url('/organization/' . $orgId . '/reportingOrg') }}" class="{{ $filled ? 'active' : '' }}" title="{{ $filled ? 'Edit' : 'Add' }} Reporting Organization" data-action="{{ $filled ? 'edit-value' : 'add' }}">
                ...
                <li>
                    {{--*/ $filled = $orgData['reporting_org']; /*--}}
                    <a href="{{ url('/organization/' . $orgId . '/identifier')  }}" class="{{ $filled ? 'active' : '' }}" title="{{ $filled ? 'Edit' : 'Add' }} Organization Identifier" data-action="{{ $filled ? 'edit-value' : 'add' }}">
        ...
        <div class="panel-body">
            <ul class="nav">
                ...
                <li>
                    ...
                    <a href="{{ url('/organization/' . $orgId . '/recipient-region-budget') }}" class="{{ $filled ? 'active' : '' }}" title="{{ $filled ? 'Edit' : 'Add' }} Recipient Region Budget" data-action="{{ $filled ? 'edit-value' : 'add' }}">
                ...
                <li>
                    ...
                    <a href="{{ url('/organization/' . $orgId . '/recipient-country-budget') }}" class="{{ $filled ? 'active' : '' }}" title="{{ $filled ? 'Edit' : 'Add' }} Recipient Country Budget" data-action="{{ $filled ? 'edit-value' : 'add' }}">
                ...
                <li>
                    ...
                    <a href="{{ url('/organization/' . $orgId . '/total-expenditure') }}" class="{{ $filled ? 'active' : '' }}" title="{{ $filled ? 'Edit' : 'Add' }} Total Expenditure" data-action="{{ $filled ? 'edit-value' : 'add' }}">
                        Total Expenditure
                    </a>
