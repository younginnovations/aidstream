    ...
    <div class="container main-container">
        <div class="row">
            ...
            <div class="col-xs-9 col-md-9 col-lg-9 content-wrapper">
                ...
                <div class="panel-content-heading panel-title-heading">Document Link of <span>{{$activityData->IdentifierTitle}}</span></div>
                        ...
                        <form class="form-horizontal" role="form" id="upload_file" method="POST" enctype="multipart/form-data" action="{{ route('document.upload') }}">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <input type="file" class="form-control" name="file" id="file" value="{{ old('file') }}" required="required">
                                </div>
                            </div>
