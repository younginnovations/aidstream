<div id="basic-info">
    ...
    <div class="col-sm-6">
        ...
        {!! Form::select('reporting_org_type', ['' => 'Select one of following:'] + $orgType, null,['class' => 'form-control', 'required' => 'required']) !!}
    </div>
    ...
    <div class="col-sm-6">
        ...
        {!! Form::select('language', ['' => 'Select one of following:'] + $language, null,['class' => 'form-control', 'required' => 'required']) !!}
    </div>
    ...
    <div class="col-sm-6">
        ...
        {!! Form::select('default_currency', ['' => 'Select one of following:'] + $currency, null,['class' => 'form-control', 'required' => 'required']) !!}
    </div>

    <div class="col-sm-6">
        {!! Form::label('default language', 'Default Language', ['class' => 'control-label required']) !!}
        {!! Form::select('default_language', ['' => 'Select one of following:'] + $language, null,['class' => 'form-control', 'required' => 'required']) !!}
    </div>
</div>
