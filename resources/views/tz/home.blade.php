...
<div class="header-banner">
    ...
    <div class="introduction-wrapper">
        <div class="container">
            <div class="col-md-12 text-center">
                <h1> Effortlessly publishing <strong>Tanzania’s</strong> Aid data in <a href="http://iatistandard.org/">IATI format</a></h1>
    ...
    <div class="info-wrapper">
        <p>AidStream Tanzania is a version of <a href="https://aidstream.org/">AidStream</a> customized to meet the needs of Tanzanian projects/ organizations. If you want to check out AidStream,
...
<script src="{{ asset('/tz/js/jquery.js') }}"></script>
<script src="{{ asset('/tz/js/modernizr.js') }}"></script>
<script type="text/javascript" src="{{ asset('/tz/js/bootstrap.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('/tz/js/jquery.mousewheel.js') }}"></script>
<script type="text/javascript" src="{{url('/js/jquery.jscrollpane.min.js')}}"></script>
<script type="text/javascript" src="{{url('/tz/js/underscore-min.js')}}"></script>
<script type="text/javascript" src="{{url('/tz/js/backbone-min.js')}}"></script>
<script type="text/javascript" src="{{url('/tz/js/regions.js')}}"></script>
<script type="text/javascript" src="{{url('/tz/js/leaflet/leaflet.js')}}"></script>
<script type="text/javascript" src="{{url('/tz/js/mapping.js')}}"></script>
