	...
	<div class="col-xs-9 col-lg-9 content-wrapper">
		...
		<div class="panel panel-default">
			<div class="panel__heading dashboard-panel__heading">
				<div>
					<div class="panel__title">@lang('np/municipalityDashboard.dashboard')</div>
					<p>@lang('np/municipalityDashboard.stats')</p>
				</div>
			</div>
				...
				<div class="panel-chart-grid">
					<div class="panel-chart-section organization">
						<div class="section-card">
							...
							<div class="body">
								<div class="stats">
									<h1 class="number">{{$organizationsCount}}</h1>
						...
						<div class="section-card">
							...
							<div class="body pie-chart">
								...
								<div class="pie-chart-datalist">
                                    ...
                                    <li class="color-grey" data-value="{{$stats['draft']}}"><span class="text">Draft</span> <span class="number">{{$stats['draft']}} <em style="width:25%"></em></span></li>
										<li class="color-light-maroon" data-value="{{$stats['completed']}}"><span class="text">Completed</span> <span class="number">{{$stats['completed']}}<em style="width: 50%"></em></span></li>
										<li class="color-purple" data-value="{{$stats['verified']}}"><span class="text">Verified</span> <span class="number">{{$stats['verified']}} <em style="width: 33%"></em></span></li>
										<li class="color-purple" data-value="{{$stats['published']}}"><span class="text">Published</span> <span class="number">{{$stats['published']}} <em style="width: 33%"></em></span></li>
									</ul>
								</div>
							</div>
						</div>
