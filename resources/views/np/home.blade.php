...
<section class="np-section feature-section">
	...
	<div class="container">
		...
		<div class="feature-description">
			...
			<p>Dhangadhi Sub-Metropolitan City has embraced open data policy and has published their development data using AidStream Nepal. <a href="{{ url('/municipality/dhangadi') }}">Know
					More</a></p>
		</div>
	</div>
