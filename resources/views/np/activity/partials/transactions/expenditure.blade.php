...
<div class="activity__detail" id="activity__expenditure">
    <div class="activity__element__list">
        <h3>
            ...
            <a href="{{ route('np.activity.transaction.edit', [$activity->id, 4]) }}"
        ...
        <a href="{{ route('np.activity.transaction.create', [$activity->id, 4]) }}"
           class="add-more"><span>@lang('lite/elementForm.add_more_expenditure')</span></a>
    </div>
</div>
@endif
